...
@section('content')
    ...
    <section class="content">
        <form method="POST" action="{{ route('gift.update', $gift->id ) }}" class="">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"
                                       name="title" id="title" value="{{ $gift->title }}" required/>
                            </div>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <div class="select-single-file">
                                    <div class="img-item">
                                        <img width="" class="img-responsive" src="{{ $gift->image }}" alt="">
                                        <input type="hidden" value="{{ $gift->image }}" name="image" id="" class="form-control ">
                                    </div>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <select name="status" id="" class="form-control">
                                    ...
                                    <option {{ ($gift->status == 1) ? 'selected' : '' }} value="1">Hoạt động</option>
                                    <option {{ ($gift->status == 0) ? 'selected' : '' }} value="0">Khoá hoạt động</option>
