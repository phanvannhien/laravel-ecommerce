...
@section('content')
    ...
    <section class="content-header">
        <a href="{{ route('inventory.index') }}" class="btn btn-info pull-right">
    ...
    <section class="content">
        <form method="POST" action="{{ route('inventory.store') }}" class="">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-sm-9">
                    <div class="box">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="contact_email" id="contact_email" placeholder="" value="{{ old('contact_email') }}"/>
                            </div>
