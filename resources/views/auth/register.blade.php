    ...
    <div class="animsition container-login100"
        ...
        <div class="wrap-login100 p-l-30 p-r-30 p-t-50 p-b-30">
            <form action="{{ route('register') }}" method="post" class="login100-form validate-form">
                ...
                <div class="wrap-input100 validate-input m-b-20" data-validate="@lang('user.email')">
                    <input autocomplete="off" class="input100"
                           value="{{ old('email') }}"
                           type="email" name="email" placeholder="@lang('user.email')">
                    <span class="focus-input100"></span>
                ...
                <div class="wrap-input100 validate-input m-b-25" data-validate = "@lang('user.password_confirm')">
                    <input value="{{ old('password_confirmation') }}"
                           autocomplete="off" class="input100"
                           type="password" name="password_confirmation" placeholder="@lang('user.password_confirm')">
                    <span class="focus-input100"></span>
